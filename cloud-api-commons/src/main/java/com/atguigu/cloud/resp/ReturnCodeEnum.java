...
public enum ReturnCodeEnum {
    ...
    private final String message; // 自定义描述
    ...
    /*public static void main(String[] args) {
        ...
        System.out.println(Objects.requireNonNull(getReturnCodeEnumV1("200")).getCode());
        System.out.println(Objects.requireNonNull(getReturnCodeEnumV1("200")).getMessage());
